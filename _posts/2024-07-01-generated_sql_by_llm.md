...
- SQL 자동 생성 기능은 LLM과의 통신, 프롬프트 작성, 데이터 스토어 접근 등 여러 구성 요소를 포함합니다. 오라클 데이터베이스 23ai에서는 DBMS_VECTOR_CHAIN 패키지를 통해 LLM과 직접 통신할 수 있으며, 이를 통해 필요한 데이터가 무엇인지 물어보고 SQL을 자동으로 작성할 수 있습니다.
